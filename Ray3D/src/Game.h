...
enum texture_enum { TEX_LOGO = 0, TEX_LOGO_SPECULAR, 
	TEX_BALL, TEX_BALL_SPECULAR,
	TEX_BLEACH, TEX_BLEACH_SPECULAR,
	TEX_FLOOR, TEX_FLOOR_SPECULAR,
	TEX_EMISSIVE, TEX_EMISSIVE_SPECULAR };
